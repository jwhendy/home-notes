...
* Discussion with Felicity
During the car ride back from Whole Foods this evening, it was really interesting meander through a discussion about gasoline, limited crude oil supplies, and sustainability/conservation of natural resources to Felicity. If you have access to a five year old and haven't done it before, I highly recommend trying to explain *anything* of moderate complexity to them. It's pretty enlightening, and they're also pretty flipping smart (moreso than I would have expected). Best recollection of some finer moments:

- Her: What happens when all the gas runs out?
- Me: Well, no one will be able to drive anymore (also thinking, but not saying, "And we'll all be farmers and/or freeze in the winter since there might not be any artificial heat generation.")
- Her: How will we get places?
- Me: We'll have to walk or bike.
- Her: Where?
- Me: Anywhere! Sidewalks, roads, highways...
- Her: But we'll get hit!
- Me: Remember, no one will be driving, so no one can hit us.

- Her: Why is the gas going to run out?
- Me: Well, you know how mama makes hummus? Do you know where it comes from?
- Her: Chick peas!
- Me: That's right. So let's say you had 25 cans of chick peas and you really liked eating hummus. Once you ate hummus 25 times, we'd have used all the chick peas and couldn't make anymore.

- Her: Where does gas come from then?
- Me (Thinking "Awww, dammit, this is going to be tough..."): Well, let's see. A long, long, long time ago there were a bunch of plants that died. You know how bananas turn brown when they get old?
- Her: Yeah 
- Me: Well, the plants sort of got all nasty like that, and after they were rotten for a long time, they turned into something called crude oil. We have to look around and find it, and use a big drill to get it out of the ground, and then turn it into gas, kind of how we make hummus from chick peas. So, it's hard to find and there's only so much of it, which is why we'll run out one day. There's a lot of people trying to think about how we could get around in cars without gas.

[Few minutes of silence]

- Her: Can we run cars on batteries?
- Me (after picking up jaw): Yes! There are lots of people trying to figure out how to run cars on batteries! But you need a lot of them and they're pretty heavy. The heavier something is, the more energy it takes to move it, so people are also trying to make cars lighter.
- Her: How?
- Me: Well, using things like plastic instead of metal.
- Her: Where?
- Me: Well, you know the outside of our van? Some cars have plastic on the outside instead of metal.
- Her: What!?!? Plastic isn't as strong as metal!!!! It's not safe!!! How can they do that!?!? (She was seriously concerned about this issue).
- Me (picked up jaw again as I didn't expect the strength comparison between two materials!): Well, they have metal inside the doors to keep it safe, but the outside part can be plastic.

Anyway, there was a bunch more and this is long already... but the point is that it's pretty interesting and you find out more about how your child's mind works as well as what you either 1) clearly don't know (I probably should have just said so a few times instead of half-BS'ing my explanations...) or 2) definitely don't know well enough to explain to a child!
